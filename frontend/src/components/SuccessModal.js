...
import { CheckCircle, Calendar, Wallet, ExternalLink } from 'lucide-react';
        ...
        >
          ...
          <div className="bg-gradient-to-r from-[#d4a853]/10 to-[#4dd4e8]/10 border border-[#d4a853]/20 rounded-xl p-4 mb-6">
            <p className="text-sm text-gray-300">
              Your <span className="font-bold text-white">{orderDetails?.quantity?.toLocaleString()} ARA tokens</span> will be automatically airdropped to your wallet:
            </p>
            <code className="block text-xs text-[#4dd4e8] font-mono mt-2 break-all">
